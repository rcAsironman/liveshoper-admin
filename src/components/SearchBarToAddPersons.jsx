...
import SearchResultToAddPersons from './SearchBarResultToAddPersons';
...
function SearchBarToAddPersons() {
    ...
    return (
        <div className='search-bar'>
            ...
            {searchInput.length > 0 && <SearchResultToAddPersons searchResult={searchResult} />} {/* Conditionally render SearchResult */}
        </div>
    )
}

export default SearchBarToAddPersons